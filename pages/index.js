...
export default function Home() {
  return (
    <div className="bg-black w-screen h-screen grid justify-items-center">
      ...
      <div className="max-w-lg md:max-w-4xl mx-auto h-screen w-screen border-2 absolute overflow-hidden">
        <Link href="/">
          <Image
        ...
        <div className="bg-[#222222] h-2/6 md:h-2/6 text-white rounded-xl shadow shadow-gray-800 mx-5 md:mx-10 mt-48 md:mt-48 ">
          {/* Page title */}
          <p className="font-bold text-center capitalize text-xl md:text-4xl py-5 md:py-10">
            welcome to spotify shop
          </p>

          {/* Demo button */}
          <div className="flex justify-center mt-10 h-16 items-center">
            <Link href="/demo">
              <m.div
                whileHover={{ scale: 1.2 }}
                whileTap={{ scale: 0.9 }}
                transition={{ type: "spring", stiffness: 400, damping: 17 }}
                className="w-36 md:w-40 h-10 md:h-12 flex items-center justify-center rounded-full bg-[#1DB954] shadow-lg cursor-pointer"
              >
